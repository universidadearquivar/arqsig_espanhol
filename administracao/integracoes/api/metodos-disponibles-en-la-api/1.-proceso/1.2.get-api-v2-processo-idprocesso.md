...
Este servicio permite a los Clientes, vía API, buscar un proceso, no excluido lógicamente, con sus respectivos datos del proceso, firmantes y documentos del proceso.

## Requisición

<figure><img src="../../../../../.gitbook/assets/image (2) (1).png" alt=""><figcaption></figcaption></figure>

#### <sup>A</sup>arquivoTipo

**Descripción:** Parámetro opcional que informa si se debe retornar el enlace para descarga o el base64 de los documentos.

**Formato:** Byte - 1 = base64, 2 = Enlace para descarga

**Requerido:&#x20;**<mark style="color:blue;">**No**</mark>

> Cuando **no sea enviado** o se **envíe un valor diferente de 1 o 2**, significa que el sistema debe considerar el valor por defecto. Es decir, **?arquivoTipo =1, retornando los documentos del proceso en formato base64.**
>
> Cuando el **valor sea 1** en el parámetro **arquivoTipo**, significa que el sistema retorna los documentos del proceso de firmas en formato base64.
>
> Cuando se envíe el valor 2 en el parámetro **arquivoTipo**, significa que el sistema **retorna el enlace para descarga de los documentos** del proceso de firmas.
>
> > **Atención**: El sistema retorna el enlace para descarga o el archivo base64. No retorna ambos formatos.

#### <sup>B</sup>retornarRegistroAssinatura

**Descripción:** Parámetro opcional que informa si retorna el registro de firma de cada documento del proceso.

**Formato:** Booleano – true o false

**Requerido:&#x20;**<mark style="color:blue;">**No**</mark>

> Cuando **no sea enviado** o se envíe el valor **true** o se envíe un valor **diferente de true o false**, el sistema considera el valor por defecto. Es decir, **retornar el registro de firma de los respectivos documentos del proceso.**
>
> Cuando el valor sea **false** en el parámetro **retornarRegistroAssinatura**, significa que el sistema **no retorna el registro de firma** de los respectivos documentos del proceso.
...
El sistema retorna la ruta de la carpeta del proceso. Para un documento con estado diferente de Concluido, si la carpeta está eliminada, se debe retornar la ruta de la carpeta raíz de la cuenta, que es donde el documento será guardado cuando sea concluido.

**Ej.:** Arquivar \\\Administración \\\\**Contratos**
...
El sistema retorna el id del estado del proceso **(1 - Creado, 2 - En espera, 3 - En proceso, 4 - Concluido o 5 - Cancelado).**
...
El sistema retorna el id del tipo de acción del firmante en el proceso, que puede ser **Firma en línea** o **Recibir una copia**.
...
El sistema debe retornar la información si hubo falla en el envío del código de seguridad:
...
El sistema retorna el id del tipo de firma que el firmante ejecutó o ejecutará. Este parámetro puede tener el valor: **1 (Firma Electrónica), 2 (Certificado Digital - ICP Brasil) o 4 (Certificado Digital – Otros).**

Cuando el **tipo de acción** del firmante sea igual a **Recibir una copia**, el parámetro **idTipoAssinatura** será **null**.
...
El sistema retorna el enlace del documento compartido por **QRCode**.

El enlace compartido del documento se genera cuando el proceso con la bandera **GerarQRCode = true** es concluido.

**linkParaBaixarDocumento**

El sistema retorna el enlace para descargar el documento, conforme al parámetro **arquivoTipo** en la solicitud.
...
El sistema retorna, para cada documento del proceso, el respectivo registro de firmas, conforme al parámetro **registroAssinatura** informado o no en la solicitud.
    ...
    "documentos": [
        {
            ...
            "linkDocumentoCompartilhado": "string",
            "linkParaBaixarDocumento": "string",
