...
* [🧩 Integraciones](administracao/integracoes/README.md)
  ...
  * [🔳 Métodos disponibles en la API](administracao/integracoes/metodos-disponiveis-na-api/README.md)
    ...
    * [✔️ PATCH/api/v2/processo/{idProcesso}/reenviar-processo](administracao/integracoes/metodos-disponiveis-na-api/patch-api-v2-processo-idprocesso-reenviar-processo.md)
    * [✔️ POST/api/v1/processo/enviar-documento-para-assinar](administracao/integracoes/metodos-disponibles-en-la-api/post-api-v1-processo-enviar-documento-para-assinar/README.md)
      * [Page 1](administracao/integracoes/metodos-disponibles-en-la-api/post-api-v1-processo-enviar-documento-para-assinar/page-1.md)
    * [✔️ GET/api/v1/processo/{idprocesso}](administracao/integracoes/metodos-disponiveis-na-api/get-api-v1-processo-idprocesso.md)
    * [✔️ GET/api/v1/processo/{idProcesso}/status-do-processo](administracao/integracoes/metodos-disponiveis-na-api/get-api-v1-processo-idprocesso-status-do-processo.md)
    * [✔️ GET/api/v1/processo/{idprocesso}/dados-signatarios](administracao/integracoes/metodos-disponiveis-na-api/get-api-v1-processo-idprocesso-dados-signatarios.md)
    * [✔️ PATCH/api/v1/processo/{idProcesso}/reenviar-processo](administracao/integracoes/metodos-disponiveis-na-api/patch-api-v1-processo-idprocesso-reenviar-processo.md)
