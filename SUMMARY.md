...
* [💻 Visión General de la Plataforma 2.6.0](README.md)
...
* [🧩 Integraciones](administracao/integracoes/README.md)
  * [🟪 API](administracao/integracoes/api/README.md)
    ...
    * [🔳 Métodos disponibles en la API](administracao/integracoes/api/metodos-disponibles-en-la-api/README.md)
      * [✔️ POST/api/v2/processo/enviar-documento-para-assinar](administracao/integracoes/api/metodos-disponibles-en-la-api/post-api-v2-processo-enviar-documento-para-assinar.md)
      * [✔️ GET/api/v2/processo/{idProcesso}](administracao/integracoes/api/metodos-disponibles-en-la-api/get-api-v2-processo-idprocesso.md)
      * [✔️ PATCH/api/v2/processo/{idProcesso}/reenviar-processo](administracao/integracoes/api/metodos-disponibles-en-la-api/patch-api-v2-processo-idprocesso-reenviar-processo.md)
      * [✔️ POST/api/v1/processo/enviar-documento-para-assinar](administracao/integracoes/api/metodos-disponibles-en-la-api/post-api-v1-processo-enviar-documento-para-assinar.md)
      * [✔️ GET/api/v1/processo/{idprocesso}](administracao/integracoes/api/metodos-disponibles-en-la-api/get-api-v1-processo-idprocesso.md)
      * [✔️ GET/api/v1/processo/{idProcesso}/status-do-processo](administracao/integracoes/api/metodos-disponibles-en-la-api/get-api-v1-processo-idprocesso-status-do-processo.md)
      * [✔️ GET/api/v1/processo/{idprocesso}/dados-signatarios](administracao/integracoes/api/metodos-disponibles-en-la-api/get-api-v1-processo-idprocesso-dados-signatarios.md)
      * [✔️ PATCH/api/v1/processo/{idProcesso}/reenviar-processo](administracao/integracoes/api/metodos-disponibles-en-la-api/patch-api-v1-processo-idprocesso-reenviar-processo.md)
      * [✔️ PATCH/api/v1/processo/{idProcesso}/cancelar-processo](administracao/integracoes/api/metodos-disponibles-en-la-api/patch-api-v1-processo-idprocesso-cancelar-processo.md)
